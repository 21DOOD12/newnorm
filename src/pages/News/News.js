  ...
  return (
    <div className="news">
      <div className="news__content">
        ...
        <NavLink className="daidjest" to="/top">
          <Button variant="contained" className="daidjest" color="primary">
            Дайджест
          </Button>
        </NavLink>
        {!!state
          ? Object.keys(state).map((post) => {  
              return (
        ...
        <div className="news__item">
          ...
          <span className="news__info">
            <p>
              ...
              <br />
              <div className="news__pic">
                <img src={codify1} alt="pic" />
                <img src={codify2} alt="pic" />

                <img src={codify3} alt="pic" />
                <img src={codify4} alt="pic" />
              </div>
            </p>
          </span>
